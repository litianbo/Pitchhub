                ...
                <div class="col-md-3">
                    <form action="" method="post">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                          <li class="active"><a href="#job1" data-toggle="tab">Change Email</a></li>
						  <li><a href="#job2" data-toggle="tab">Change Password</a></li>
                        </ul>
                    </form>
                ...
                <div class="col-md-9">
                    ...
                    <div class="tab-content" style="background-color: #f8f8f8">
                        ...
                        <div class="tab-pane fade active in" style="background-color: white; vertical-align: middle; padding: 25px" align="center" id="job1">
                            <!-- Account Info -->
                            <br />
							<form method="post" action="newemail.php" enctype="multipart/form-data" onsubmit = "return checkEmail(this)">
                            <input type="email" class="form-control"  name = "email" placeholder="Enter new email" required style = "width: 400px">
                            <br />

                            <input type="email" class="form-control"   name = "email2" placeholder="Re-type new email"  style = "width: 400px">
                            <br />
                        ...
                        <div class="tab-pane fade in" style="background-color: white; vertical-align: middle; padding: 25px" align="center" id="job2">
                            <!-- Profile Photo -->
                            <br />
